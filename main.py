...
# dentro de file, tools e help nós temos as listas
...
class App:
    def __init__(self):
        self.window = sg.Window('Dev Rapd em Py Calculator', layout=layout, margins=(0, 0), resizable=True, return_keyboard_events=False)
        self.result = 0
        self.oper = ''
    ...
    def sobre(self):
        sg.popup('Sobre', 'just an example',)
